# Ported from Motif (feature/wellness-wizard:demo/wellness/today_brief.py)
...
def briefing():
    from superapp.experience import life_stats as LS
...
def alive():
    ...
    from superapp.experience.store import load_fitness, load_goals, load_habits
